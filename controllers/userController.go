...
import (
	...
	helper "github.com/siddharth-sable/go-jwt-project/helpers"
	"github.com/siddharth-sable/go-jwt-project/models"

	"github.com/gin-gonic/gin"
	"github.com/go-playground/validator/v10"
	"github.com/siddharth-sable/go-jwt-project/database"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Error occurred while chekcing for the email"})
		}
